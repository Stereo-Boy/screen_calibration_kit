function [gammaTable2, gammaTable1, displayBaseline, displayRange, displayGamma, maxLevel ] = CalibrateMonitorPhotometerDual(numMeasures)
% [gammaTable2, gammaTable1, displayBaseline, displayRange. displayGamma, maxLevel ] = CalibrateMonitorPhotometer([numMeasures=9])
%
...
KbName('UnifyKeyNames');
    ...
    try
        ...
        win = PsychImaging('OpenWindow', 1, 255, [], [], [], scr.stereoMode);
        ...
        inputV(end) = maxLevel;
        for i = inputV
            Screen('SelectStereoDrawBuffer', win, 0); % fill first screen
            Screen('FillRect',win,i);
            Screen('SelectStereoDrawBuffer', win, 1); % fill second screen
            Screen('FillRect',win,i);
            Screen('Flip',win);
